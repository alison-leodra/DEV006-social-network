...
appContainer.innerHTML = inicioTemplate();

// Esconder templates
const esconderElemento = (selector) => {
...
const btnRegistro = document.querySelector(".signbtn");
btnRegistro.addEventListener("click", () => {
  esconderElemento(".inicioTemplate");
  appContainer.innerHTML = registroOption();
  mostrarRegistroEmail();
})


// Mostrar registro con Email
const mostrarRegistroEmail = () => {
  const btnRegistroCorreo = document.querySelector(".signInFormEmail");
  btnRegistroCorreo.addEventListener("click", () => {
    esconderElemento(".registroOption");
    appContainer.innerHTML = registroEmail();
  });
}